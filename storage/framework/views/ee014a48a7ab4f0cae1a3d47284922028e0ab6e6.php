...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/https://fonts.googleapis.com/css?family=Mukta:300,400,700')); ?>"> 
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                <ul>
                  ...
                  <li>
                    <a href="<?php echo e(route('cart')); ?>" class="site-cart">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="<?php echo e(asset('public/images/picture8.jpg')); ?>" alt="Image placeholder" class="img-fluid rounded mb-4">
              <h3 class="font-weight-light  mb-0">Finding Your Perfect Watches</h3>
            ...
            <div class="block-7">
              <form action="#" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="button" class="btn btn-sm btn-primary" value="Send">
                </div>
              </form>
            </div>
          </div>
  ...
  <script src="<?php echo e(asset('public/js/mains.js')); ?>"></script>

  <script>
    $(document).ready(function(){
      $('.btn-sm.btn-primary').click(function(){
        BaseRecord.mailer($('#email_subscribe').val());
      });
